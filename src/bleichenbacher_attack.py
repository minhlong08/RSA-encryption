...
#             if a == b:
#                 m = a
#                 print("[+] Found exact plaintext integer:", m)
#                 m_bytes = m.to_bytes(k, 'big')
#                 unpadded = rsa._pkcs1_v15_unpad(m_bytes)
#                 print("[+] Recovered message:", unpadded)
#                 return unpadded
            
# def main():
#     rsa = RSAWithPKCS1(key_size=128)
...
#         print("This simple demo implementation only works with single-block messages.")
#         return
    
#     recovered = bleichenbacher_attack(ciphertext[0], rsa)
#     print("[✓] Attack success:", recovered == plaintext)
#     print(f"Recover message: {recovered}")
